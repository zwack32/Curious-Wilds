...
var water = 1200.0 #centicups
var energy = 30000.0 #Kcals
...
@onready var health_bar = $PlayerCaerma/HealthBar
@onready var temperature_bar = $PlayerCaerma/TemperatureBar
@onready var water_bar = $PlayerCaerma/WaterBar
@onready var energy_bar = $PlayerCaerma/EnergyBar
